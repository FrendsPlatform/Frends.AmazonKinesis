...
public class ErrorHandlerTest
{
    ...
    public void Should_Throw_Error_When_ThrowErrorOnFailure_Is_True()
    {
        var ex = Assert.ThrowsAsync<Exception>(new AsyncTestDelegate(() =>
           AmazonKinesis.PutRecords(DefaultInput(), DefaultConnection(), DefaultOptions(), CancellationToken.None)));
    ...
    public void Should_Use_Custom_ErrorMessageOnFailure()
    {
        ...
        var ex = Assert.ThrowsAsync<Exception>(new AsyncTestDelegate(() =>
            AmazonKinesis.PutRecords(DefaultInput(), DefaultConnection(), options, CancellationToken.None)));
        Assert.That(ex, Is.Not.Null);
