...
public class ErrorHandlerTest
{
    ...
    {
        Func<Task> act = () => AmazonKinesis.PutRecords(DefaultInput(), DefaultConnection(), DefaultOptions(), CancellationToken.None);
    ...
    public async Task Should_Return_Failed_Result_When_ThrowErrorOnFailure_Is_False()
    {
        ...
        var result = await AmazonKinesis.PutRecords(DefaultInput(), DefaultConnection(), options, CancellationToken.None);
    ...
    public void Should_Use_Custom_ErrorMessageOnFailure()
    {
        ...
        Func<Task> act = () => AmazonKinesis.PutRecords(DefaultInput(), DefaultConnection(), options, CancellationToken.None);
        var ex = Assert.ThrowsAsync<Exception>(act);
        Assert.That(ex, Is.Not.Null);
